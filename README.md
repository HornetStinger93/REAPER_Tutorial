# Don't Fear the Reaper, or How to Basically Record in Reaper
...
## Prerequisites
  There are some required items for this tutorial. While one could probably make due without them, it is better to have them as it will make this tutorial easier to understand. 
  - A Midi Keyboard
